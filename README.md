# 🐺 Grey Wolf Optimization (GWO) - Nhóm 114
...
Đây là phần demo mã nguồn thuộc báo cáo bài tập lớn của **Nhóm 114**.  
...
## 2. Thông tin nhóm thực hiện (Team Members)
...
## 3. Chi tiết thuật toán (Algorithm Implementation)
...
- Vị trí mới được tính theo công thức:
...
## 4. Bài toán Demo: Tối ưu hàm phi tuyến
...
- Đơn giản nhưng đặc trưng để quan sát hành vi của GWO  
- Dễ mở rộng sang bài toán tuning tham số, tối ưu mô hình,...

---

## 5. Cài đặt và Sử dụng (Installation & Usage)
